 ...
 * Complex branches with multiple features (rebase from master before merge) 
 ...
 * Merge/squashing contributor work (one bug / feature)
 * Giving credit to patch authors when squashing
 * Interactive rebasing to clean up other people's branches
